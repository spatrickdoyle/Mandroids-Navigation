...
int main(int argc, char *argv[]){
	...
	float dpp_h = 0.06013;//DEGREES PER PIXEL HORIZONTALLY. Total angle of view: 76.96 degrees
	float dpp_v = 0.06939;//DEGREES PER PIXEL VERTICALLY//Total angle of view: 49.96 degrees
